class SearchBar extends HTMLElement {
  ...
  handleInput() {
      ...
      }, 500); // Attendre 500ms avant de faire la requête API
  }
  ...
  renderSuggestions(suggestions) {
      this.suggestionsElement.innerHTML = ""; // Effacer les suggestions précédentes
      ...
      suggestions.forEach((suggestion) => {
          ...
          // Ajouter les coordonnées GPS dans l'élément de suggestion pour pouvoir les récupérer facilement
  ...
  selectSuggestion(event) {
      if (event.target.classList.contains("suggestion-item")) {
          ...
          // Émettre un événement personnalisé avec l'adresse et les coordonnées GPS
